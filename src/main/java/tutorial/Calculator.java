...
public class Calculator {
  ...
  public interface Iface extends SharedService.Iface {
    ...
    public int calculate(int logid, Work w) throws tutorial.InvalidOperation, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends SharedService .AsyncIface {
    ...
    public void calculate(int logid, tutorial.Work w, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends SharedService.Client implements Iface {
    ...
    public int calculate(int logid, tutorial.Work w) throws tutorial.InvalidOperation, org.apache.thrift.TException
    {
      send_calculate(logid, w);
      return recv_calculate();
    }

    public void send_calculate(int logid, tutorial.Work w) throws org.apache.thrift.TException
    {
    ...
    public int recv_calculate() throws tutorial.InvalidOperation, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends SharedService.AsyncClient implements AsyncIface {
    ...
    public static class calculate_call extends org.apache.thrift.async.TAsyncMethodCall<Integer> {
      private int logid;
      private tutorial.Work w;
      public calculate_call(int logid, tutorial.Work w, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.logid = logid;
        this.w = w;
      }
      ...
      public Integer getResult() throws tutorial.InvalidOperation, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class calculate<I extends Iface> extends org.apache.thrift.ProcessFunction<I, calculate_args> {
      ...
      public calculate_result getResult(I iface, calculate_args args) throws org.apache.thrift.TException {
        ...
        try {
          ...
          result.setSuccessIsSet(true);
        } catch (tutorial.InvalidOperation ouch) {
          result.ouch = ouch;
        }
        return result;
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Integer> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Integer>() { 
          ...
          public void onError(Exception e) {
            ...
            org.apache.thrift.TSerializable msg;
            calculate_result result = new calculate_result();
            if (e instanceof tutorial.InvalidOperation) {
              result.ouch = (tutorial.InvalidOperation) e;
...
;
  ...
  public static class calculate_args implements org.apache.thrift.TBase<calculate_args, calculate_args._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_args>   {
    ...
    public tutorial.Work w; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.W, new org.apache.thrift.meta_data.FieldMetaData("w", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, tutorial.Work.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public calculate_args(calculate_args other) {
      ...
      if (other.isSetW()) {
        this.w = new tutorial.Work(other.w);
      }
    }
    ...
    public tutorial.Work getW() {
      return this.w;
    }

    public calculate_args setW(tutorial.Work w) {
      this.w = w;
      return this;
    }
  ...
  public static class calculate_result implements org.apache.thrift.TBase<calculate_result, calculate_result._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_result>   {
    ...
    public int success; // required
    public tutorial.InvalidOperation ouch; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.OUCH, new org.apache.thrift.meta_data.FieldMetaData("ouch", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, tutorial.InvalidOperation.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public calculate_result(
      int success,
      tutorial.InvalidOperation ouch)
    {
      this();
      this.success = success;
      setSuccessIsSet(true);
    ...
    public calculate_result(calculate_result other) {
      ...
      this.success = other.success;
      if (other.isSetOuch()) {
        this.ouch = new tutorial.InvalidOperation(other.ouch);
      }
    }
    ...
    public tutorial.InvalidOperation getOuch() {
      return this.ouch;
    }

    public calculate_result setOuch(tutorial.InvalidOperation ouch) {
      this.ouch = ouch;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OUCH:
        if (value == null) {
          ...
          setOuch((tutorial.InvalidOperation)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, calculate_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // OUCH
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.ouch = new tutorial.InvalidOperation();
